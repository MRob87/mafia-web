...
<p>
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-122%20passing-brightgreen?logo=vitest&logoColor=white">
</p>
...
- 🐺 **Editions** — the host picks a skin per room at creation (**Mafia** by default, or **Werewolf**, **Space Station**, **Alien**); the engine is identical, only the role names, emoji, and narration change
